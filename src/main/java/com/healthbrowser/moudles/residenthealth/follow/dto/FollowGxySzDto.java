 ...
 * @date 2019年7月31日
 */
public class FollowGxySzDto extends BaseDto implements Serializable {
	...
	private List<FollowGxySzmqyyDto> gxySzmqyy;//高血压首诊目前用药表
	private List<FollowGxySzywzlbDto> gxySzywzlbs;//高血压首诊药物治疗表
	
	public List<FollowGxySzmqyyDto> getGxySzmqyy() {
		return gxySzmqyy;
	}
	public void setGxySzmqyy(List<FollowGxySzmqyyDto> gxySzmqyy) {
		this.gxySzmqyy = gxySzmqyy;
	}
	public List<FollowGxySzywzlbDto> getGxySzywzlbs() {
		return gxySzywzlbs;
	}
	public void setGxySzywzlbs(List<FollowGxySzywzlbDto> gxySzywzlbs) {
