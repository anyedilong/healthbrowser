 ...
 * @date 2019年8月2日
 */
public class FollowLnrZyyglDto extends BaseDto implements Serializable {
    ...
    // 随访-老年人-中医药管理-结果
    private FollowLnrZyyglJgDto followLnrZyyglJg;


    public FollowLnrZyyglJgDto getFollowLnrZyyglJg() {
		return followLnrZyyglJg;
	}

	public void setFollowLnrZyyglJg(FollowLnrZyyglJgDto followLnrZyyglJg) {
