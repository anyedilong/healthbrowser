 ...
 * @date 2019年7月31日
 */
public class FollowTnbDto extends BaseDto implements Serializable {
	...
	private FollowTnbJbDto followTnbJb;
	...
	private String ywdwkhp1;// 药物单位片或颗粒
	private String ywdwkhp2;// 药物单位片或颗粒
	private String ywdwkhp3;// 药物单位片或颗粒
	...
	public FollowTnbJbDto getFollowTnbJb() {
		return followTnbJb;
	}

	public void setFollowTnbJb(FollowTnbJbDto followTnbJb) {
