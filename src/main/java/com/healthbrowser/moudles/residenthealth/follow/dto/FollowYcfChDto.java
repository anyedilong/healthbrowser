...
/**
 * @ClassName: FollowYcfCh
 * @Description: 随访-孕产妇-产后访视
 * @author Administrator
 * @date 2019年8月2日
 */
public class FollowYcfChDto extends BaseDto implements Serializable {

	private static final long serialVersionUID = 18789466666L;
	...
	public String getQtflms() {
		return this.qtflms;
	}

	public void setQtflms(String qtflms) {
		this.qtflms = qtflms;
	}
