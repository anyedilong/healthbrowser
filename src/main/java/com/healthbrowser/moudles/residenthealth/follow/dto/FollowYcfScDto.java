 ...
 * @date 2019年8月2日
 */
public class FollowYcfScDto extends BaseDto implements Serializable {
	...
	private FollowYcfScFzjcDto followYcfScFzjc;

	private FollowYcfJbDto followYcfJb;
	...
	public FollowYcfScFzjcDto getFollowYcfScFzjc() {
		return followYcfScFzjc;
	}

	public void setFollowYcfScFzjc(FollowYcfScFzjcDto followYcfScFzjc) {
		this.followYcfScFzjc = followYcfScFzjc;
	}

	public FollowYcfJbDto getFollowYcfJb() {
		return followYcfJb;
	}

	public void setFollowYcfJb(FollowYcfJbDto followYcfJb) {
