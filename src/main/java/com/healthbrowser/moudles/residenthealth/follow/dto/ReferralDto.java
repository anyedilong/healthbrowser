...
public class ReferralDto implements Serializable {
    ...
    private static final long serialVersionUID = 16541666633L;
    @Id
    private String id;
    private String idcard;//   成员身份证号
    @JSONField(format = "yyyy-MM-dd")
    private Date referralTime;//   初次转出时间
    ...
    private BaseCustomerDomainDto Customer;// 户主基本信息
    ...
    public BaseCustomerDomainDto getCustomer() {
		return Customer;
	}

	public void setCustomer(BaseCustomerDomainDto customer) {
		Customer = customer;
	}
