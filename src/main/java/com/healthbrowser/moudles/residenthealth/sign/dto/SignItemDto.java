...
public class SignItemDto implements Serializable {
	...
	// 加附件
	@Transient
	private List<SignItemAnnexDto> signItemAnnexList;
	...
	public List<SignItemAnnexDto> getSignItemAnnexList() {
		return signItemAnnexList;
	}

	public void setSignItemAnnexList(List<SignItemAnnexDto> signItemAnnexList) {
